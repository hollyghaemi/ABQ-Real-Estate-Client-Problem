...
#dataframe with applicant_sex_name, will be a translator
df_applicant_sex_name = df.copy()
df_applicant_sex_name['applicant_sex_name_code'] = lb_make.fit_transform(df_applicant_sex_name['applicant_sex_name'])
df_applicant_sex_name = df_applicant_sex_name[['sequence_number', 'applicant_sex_name', 'applicant_sex_name_code']]
df_applicant_sex_name.head()

#dataframe with applicant_race_name_1, will be a translator
df_applicant_race_name_1= df.copy()
df_applicant_race_name_1['applicant_race_name_1_code'] = lb_make.fit_transform(df_applicant_race_name_1['applicant_race_name_1'])
df_applicant_race_name_1 = df_applicant_race_name_1[['sequence_number', 'applicant_race_name_1', 'applicant_race_name_1_code']]
df_applicant_race_name_1.head()
